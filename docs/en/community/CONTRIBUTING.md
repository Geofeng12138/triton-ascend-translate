...
To avoid inconsistency between multiple branches, please create a new local development branch for developing new features.
...
- What kind of issue are you reporting? Add the corresponding label to highlight it on the issue dashboard.
- What happened?
...
- If you find an open issue that you intend to resolve, please comment on that issue to let others know you will be working on it.
- If the issue has been open for a while, please perform a preliminary check before resolving it.
- If you resolve an issue you reported yourself, you still need to let others know before closing it.
...
- After sufficient discussion, the PR will be merged, rejected, or abandoned based on the discussion results.
