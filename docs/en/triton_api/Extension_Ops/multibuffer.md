...
The following example demonstrates how to set up multi-buffering for the tensor `tmp0` in the kernel and use it in combination with other compilation hints:
