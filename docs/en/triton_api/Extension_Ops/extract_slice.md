...
| `offsets`     | `tuple of ints`  | The starting offsets of the slice along each dimension             |
| `sizes`       | `tuple of ints`  | The size of the slice along each dimension                         |
| `strides`     | `tuple of ints`  | The stride of the slice along each dimension                       |
| `_builder`    | -                | Reserved parameter, external calls are not supported               |
| `_generator`  | -                | Reserved parameter, external calls are not supported               |
