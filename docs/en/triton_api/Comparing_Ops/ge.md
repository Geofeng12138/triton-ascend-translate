...
Triton-Ascend lacks fp64 support compared to GPU. Support for uint8/uint16/uint32/uint64 is under development.


### 2.4 Usage


The following example implements the greater-than-or-equal-to operation on three-dimensional tensors `x0` and `x1`:
