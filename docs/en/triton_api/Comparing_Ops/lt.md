...
Introduction: Used to compare the elements of two tensors, equivalent to `<`.  
Function prototype:
...
The following example implements a less-than operation on the three-dimensional tensors `x0` and `x1`:
