...
Introduction: This function is used to compute the element-wise fast square root of x.
...
The following example implements an element-wise fast square root on the input tensor `x`:
