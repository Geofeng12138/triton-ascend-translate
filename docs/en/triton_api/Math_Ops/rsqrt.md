...
Introduction: Computes the element-wise reciprocal square root of x.
...
The following example implements the element-wise reciprocal square root of the input tensor `x`:
