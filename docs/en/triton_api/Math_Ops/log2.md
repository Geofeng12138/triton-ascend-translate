...
Introduction: Compute the element-wise logarithm (base 2) of x.
...
Conclusion: Ascend lacks fp64 support compared to GPU, but additionally supports fp16 and bf16. torch_npu supports uint8.
...
The following example implements element-wise logarithm (base 2) on the input tensor `x`:
