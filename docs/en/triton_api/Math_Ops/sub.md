...
Introduction: Subtraction, the arithmetic operation '-', without the tl.sub method.
...
The following example implements subtraction on the input tensors `in_ptr0, in_ptr1`:
