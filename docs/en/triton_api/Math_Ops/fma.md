...
Introduction: Compute the element-wise fused multiply-add operation of x, y, and z.
...
The following example implements element-wise fused multiply-add operation on input tensors `x`, `y`, and `z`:
