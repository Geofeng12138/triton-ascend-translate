...
Conclusion: Ascend lacks fp64 support compared to GPU, but adds support for fp16 and bf16. torch_npu does not support u8.
...
The following example implements element-wise exponentiation of the input tensor `x`:
