...
Introduction: Compute the element-wise exact square root of x (rounded according to IEEE standard).
...
Conclusion: Ascend supports fp16 and bf16 in addition to GPU.  
