...
Create a view of the tensor, changing the shape without copying data, similar to reshape, but with a stronger emphasis on the concept of a view, maintaining data continuity in memory.
...
- Create a view of the tensor, changing the shape without copying the data  
