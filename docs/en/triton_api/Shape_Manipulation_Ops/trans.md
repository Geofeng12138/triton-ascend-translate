...
Transposes the dimensions of a tensor according to the `dims` parameter, without changing the tensor's data, only altering the order of the dimensions. A specially optimized transpose operation.
...
- A specifically optimized transpose operation
