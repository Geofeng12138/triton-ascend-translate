...
- Expand dimensions of size 1 to the corresponding dimension size in the target shape
...
|----------------|--------|----------|--------------------------------------------------|
| input          | tensor | Yes      | First input tensor, must be RankedTensorType     |
| other          | tensor | Yes      | Second input tensor, must be RankedTensorType    |
...
- **Type:** tensor
- **Shape:** The target shape that the two tensors are compatible with
