...
Introduction: Perform a gather operation on the `src` tensor along the `axis` dimension according to the `index`. The meaning of the gather operation is illustrated in the figure below:  
![image](./gather.png)  
Prototype:
