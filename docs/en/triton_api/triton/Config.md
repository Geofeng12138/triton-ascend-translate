...
An object representing the kernel configurations that automatic tuning may attempt.
...
- num_stages – The number of stages the compiler should use when software pipelining loops. This is particularly useful for matrix multiplication workloads on SM80+ GPUs.


- num_ctas - Number of blocks in a block cluster. Only applicable for SM90+.
