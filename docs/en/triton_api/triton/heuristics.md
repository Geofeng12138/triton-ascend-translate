...
Decorator used to specify how certain meta-parameter values are computed. This is particularly useful in scenarios where automatic tuning is too costly or not applicable.
